...
<html lang="en-IN" dir="ltr">
  ...
  <body onload="ready()" style="font-family: 'Source Sans Pro', sans-serif;">
    <div class="container">
    ...
    <p style="font-size: 19px; margin-top: 280px; font-weight: 600; padding-bottom: 45px; color:aliceblue; font-family: 'Source Sans Pro', sans-serif;" class="text-center align-bottom mb-4">Developed by Team Tech Phantoms, led by <b>Karan Sharma</b>  and sustained by <b>Aditi Pareek</b>.</p>    
